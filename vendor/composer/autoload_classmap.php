...
return array(
    ...
    'Yoast\\WP\\Duplicate_Post\\Tests\\Admin\\Options_Form_Generator_Test' => $baseDir . '/tests/admin/options-form-generator-test.php',
    'Yoast\\WP\\Duplicate_Post\\Tests\\Admin\\Options_Inputs_Test' => $baseDir . '/tests/admin/options-inputs-test.php',
    'Yoast\\WP\\Duplicate_Post\\Tests\\Admin\\Options_Page_Test' => $baseDir . '/tests/admin/options-page-test.php',
    'Yoast\\WP\\Duplicate_Post\\Tests\\Admin\\Options_Test' => $baseDir . '/tests/admin/options-test.php',
    'Yoast\\WP\\Duplicate_Post\\Tests\\Handlers\\Check_Changes_Handler_Test' => $baseDir . '/tests/handlers/check-changes-handler-test.php',
    'Yoast\\WP\\Duplicate_Post\\Tests\\Permissions_Helper_Test' => $baseDir . '/tests/permissions-helper-test.php',
    'Yoast\\WP\\Duplicate_Post\\Tests\\Post_Duplicator_Test' => $baseDir . '/tests/post-duplicator-test.php',
    'Yoast\\WP\\Duplicate_Post\\Tests\\Post_Republisher_Test' => $baseDir . '/tests/post-republisher-test.php',
    'Yoast\\WP\\Duplicate_Post\\Tests\\Revisions_Migrator_Test' => $baseDir . '/tests/revisions-migrator-test.php',
    'Yoast\\WP\\Duplicate_Post\\Tests\\TestCase' => $baseDir . '/tests/testcase.php',
    'Yoast\\WP\\Duplicate_Post\\Tests\\UI\\Admin_Bar_Test' => $baseDir . '/tests/ui/admin-bar-test.php',
    'Yoast\\WP\\Duplicate_Post\\Tests\\UI\\Asset_Manager_Test' => $baseDir . '/tests/ui/asset-manager-test.php',
    'Yoast\\WP\\Duplicate_Post\\Tests\\UI\\Block_Editor_Test' => $baseDir . '/tests/ui/block-editor-test.php',
    'Yoast\\WP\\Duplicate_Post\\Tests\\UI\\Bulk_Actions_Test' => $baseDir . '/tests/ui/bulk-actions-test.php',
    'Yoast\\WP\\Duplicate_Post\\Tests\\UI\\Classic_Editor_Test' => $baseDir . '/tests/ui/classic-editor-test.php',
    'Yoast\\WP\\Duplicate_Post\\Tests\\UI\\Column_Test' => $baseDir . '/tests/ui/column-test.php',
    'Yoast\\WP\\Duplicate_Post\\Tests\\UI\\Link_Builder_Test' => $baseDir . '/tests/ui/link-builder-test.php',
    'Yoast\\WP\\Duplicate_Post\\Tests\\UI\\Metabox_Test' => $baseDir . '/tests/ui/metabox-test.php',
    'Yoast\\WP\\Duplicate_Post\\Tests\\UI\\Post_States_Test' => $baseDir . '/tests/ui/post-states-test.php',
    'Yoast\\WP\\Duplicate_Post\\Tests\\UI\\Row_Actions_Test' => $baseDir . '/tests/ui/row-actions-test.php',
    'Yoast\\WP\\Duplicate_Post\\Tests\\Utils_Test' => $baseDir . '/tests/utils-test.php',
    'Yoast\\WP\\Duplicate_Post\\Tests\\Watchers\\Bulk_Actions_Watcher_Test' => $baseDir . '/tests/watchers/bulk-actions-watcher-test.php',
    'Yoast\\WP\\Duplicate_Post\\Tests\\Watchers\\Copied_Post_Watcher_Test' => $baseDir . '/tests/watchers/copied-post-watcher-test.php',
    'Yoast\\WP\\Duplicate_Post\\Tests\\Watchers\\Link_Actions_Watcher_Test' => $baseDir . '/tests/watchers/link-actions-watcher-test.php',
    'Yoast\\WP\\Duplicate_Post\\Tests\\Watchers\\Original_Post_Watcher_Test' => $baseDir . '/tests/watchers/original-post-watcher-test.php',
    'Yoast\\WP\\Duplicate_Post\\Tests\\Watchers\\Republished_Post_Watcher_Test' => $baseDir . '/tests/watchers/republished-post-watcher-test.php',
