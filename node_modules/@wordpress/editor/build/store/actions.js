...
var _marked = /*#__PURE__*/_regenerator.default.mark(setupEditor),
    ...
    _marked8 = /*#__PURE__*/_regenerator.default.mark(redo),
    _marked9 = /*#__PURE__*/_regenerator.default.mark(undo),
    _marked10 = /*#__PURE__*/_regenerator.default.mark(resetEditorBlocks);
...
function __experimentalOptimisticUpdatePost(edits) {
  return _objectSpread(_objectSpread({}, updatePost(edits)), {}, {
    optimist: {
    ...
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 42:
          ...
          _context4.t7 = _noticeBuilder.getNotificationArgumentsForSaveSuccess;
  ...
  return _regenerator.default.wrap(function autosave$(_context7) {
    while (1) {
      switch (_context7.prev = _context7.next) {
        case 0:
          _ref = _args8.length > 0 && _args8[0] !== undefined ? _args8[0] : {}, _ref$local = _ref.local, local = _ref$local === void 0 ? false : _ref$local, options = (0, _objectWithoutProperties2.default)(_ref, ["local"]);
...
function redo() {
  return _regenerator.default.wrap(function redo$(_context8) {
    while (1) {
...
function undo() {
  return _regenerator.default.wrap(function undo$(_context9) {
    while (1) {
...
function resetEditorBlocks(blocks) {
  ...
  return _regenerator.default.wrap(function resetEditorBlocks$(_context10) {
    while (1) {
      switch (_context10.prev = _context10.next) {
        ...
        case 6:
          _yield$select2 = _context10.sent;
          id = _yield$select2.id;
          type = _yield$select2.type;
          _context10.next = 11;
          return (0, _dataControls.syncSelect)('core', 'getEditedEntityRecord', 'postType', type, id);
