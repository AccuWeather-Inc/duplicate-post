        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", Promise.all(queries).then(function (results) {
              return (0, _lodash.map)((0, _lodash.flatten)(results).filter(function (result) {
                return !!result.id;
...
var EditorProvider = /*#__PURE__*/function (_Component) {
  ...
  (0, _createClass2.default)(EditorProvider, [{
    ...
    value: function getBlockEditorSettings(settings, reusableBlocks, hasUploadPermissions, canUserUseUnfilteredHTML, undo, shouldInsertAtTheTop) {
      return _objectSpread(_objectSpread({}, (0, _lodash.pick)(settings, ['__experimentalBlockDirectory', '__experimentalBlockPatterns', '__experimentalBlockPatternCategories', '__experimentalEnableFullSiteEditing', '__experimentalEnableFullSiteEditingDemo', '__experimentalFeatures', '__experimentalGlobalStylesUserEntityId', '__experimentalGlobalStylesBaseStyles', '__experimentalGlobalStylesContexts', '__experimentalPreferredStyleVariations', '__experimentalSetIsInserterOpened', 'alignWide', 'allowedBlockTypes', 'availableLegacyWidgets', 'bodyPlaceholder', 'codeEditingEnabled', 'colors', 'disableCustomColors', 'disableCustomFontSizes', 'disableCustomGradients', 'enableCustomUnits', 'enableCustomLineHeight', 'focusMode', 'fontSizes', 'gradients', 'hasFixedToolbar', 'hasReducedUI', 'imageEditing', 'imageSizes', 'imageDimensions', 'isRTL', 'keepCaretInsideBlock', 'maxWidth', 'onUpdateDefaultBlockStyles', 'styles', 'template', 'templateLock', 'titlePlaceholder'])), {}, {
        ...
        __experimentalFetchLinkSuggestions: (0, _lodash.partialRight)(fetchLinkSuggestions, settings),
    ...
    value: function render() {
      ...
      var editorSettings = this.getBlockEditorSettings(settings, reusableBlocks, hasUploadPermissions, canUserUseUnfilteredHTML, undo, isPostTitleSelected);
      ...
      }, children, (0, _element.createElement)(_reusableBlocks.ReusableBlocksMenuItems, null), (0, _element.createElement)(_convertToGroupButtons.default, null))))));
    }
  }]);
...
var _default = (0, _compose.compose)([_withRegistryProvider.default, (0, _data.withSelect)(function (select) {
  ...
  return {
    ...
    resetEditorBlocksWithoutUndoLevel: function resetEditorBlocksWithoutUndoLevel(blocks, options) {
      resetEditorBlocks(blocks, _objectSpread(_objectSpread({}, options), {}, {
