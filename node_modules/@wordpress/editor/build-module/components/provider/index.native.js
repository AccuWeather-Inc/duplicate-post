 ...
 */
import RNReactNativeGutenbergBridge, { subscribeParentGetHtml, subscribeParentToggleHTMLMode, subscribeUpdateHtml, subscribeSetTitle, subscribeMediaAppend, subscribeReplaceBlock, subscribeUpdateTheme, subscribeUpdateCapabilities, subscribeShowNotice } from '@wordpress/react-native-bridge';
/**
 * WordPress dependencies
 */
...
import { validateThemeColors, validateThemeGradients } from '@wordpress/block-editor';
...
var NativeEditorProvider = /*#__PURE__*/function (_Component) {
  ...
  _createClass(NativeEditorProvider, [{
    ...
    value: function componentDidMount() {
      ...
      var capabilities = this.props.capabilities;
      ...
      this.subscriptionParentReplaceBlock = subscribeReplaceBlock(function (payload) {
      ...
      this.subscriptionParentUpdateTheme = subscribeUpdateTheme(function (theme) {
      ...
      this.subscriptionParentUpdateCapabilities = subscribeUpdateCapabilities(function (payload) {
        _this2.updateCapabilitiesAction(payload);
      });
      this.subscriptionParentShowNotice = subscribeShowNotice(function (payload) {
        _this2.props.createInfoNotice(payload.message);
      });
    }
  }, {
...
export default compose([withSelect(function (select) {
  ...
  var _dispatch = dispatch('core/editor'),
      ...
      createInfoNotice = _dispatch.createInfoNotice;
