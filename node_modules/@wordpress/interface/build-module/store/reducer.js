...
export function singleEnableItems() {
  ...
  return _objectSpread(_objectSpread({}, state), {}, _defineProperty({}, itemType, _objectSpread(_objectSpread({}, state[itemType]), {}, _defineProperty({}, scope, item || null))));
}
/**
...
export function multipleEnableItems() {
  ...
  return _objectSpread(_objectSpread({}, state), {}, _defineProperty({}, itemType, _objectSpread(_objectSpread({}, currentTypeState), {}, _defineProperty({}, scope, _objectSpread(_objectSpread({}, currentScopeState), {}, _defineProperty({}, item, isEnable || false))))));
}
