...
function terms() {
  ...
  switch (action.type) {
    case 'RECEIVE_TERMS':
      return _objectSpread(_objectSpread({}, state), {}, (0, _defineProperty2.default)({}, action.taxonomy, action.terms));
  }
...
function users() {
  ...
  switch (action.type) {
    case 'RECEIVE_USER_QUERY':
      return {
        byId: _objectSpread(_objectSpread({}, state.byId), (0, _lodash.keyBy)(action.users, 'id')),
        queries: _objectSpread(_objectSpread({}, state.queries), {}, (0, _defineProperty2.default)({}, action.queryID, (0, _lodash.map)(action.users, function (user) {
          return user.id;
        })))
      };
  }
...
function themes() {
  ...
  switch (action.type) {
    case 'RECEIVE_CURRENT_THEME':
      return _objectSpread(_objectSpread({}, state), {}, (0, _defineProperty2.default)({}, action.currentTheme.stylesheet, action.currentTheme));
  }
    ...
    edits: function edits() {
      ...
      switch (action.type) {
        ...
        case 'EDIT_ENTITY_RECORD':
          ...
          return _objectSpread(_objectSpread({}, state), {}, (0, _defineProperty2.default)({}, action.recordId, nextEdits));
      }
    ...
    saving: function saving() {
      ...
      switch (action.type) {
        ...
        case 'SAVE_ENTITY_RECORD_FINISH':
          return _objectSpread(_objectSpread({}, state), {}, (0, _defineProperty2.default)({}, action.recordId, {
  ...
  if (!entitiesDataReducer || newConfig !== state.config) {
    ...
    entitiesDataReducer = (0, _data.combineReducers)(Object.entries(entitiesByKind).reduce(function (memo, _ref) {
      ...
      var kindReducer = (0, _data.combineReducers)(subEntities.reduce(function (kindMemo, entityConfig) {
        return _objectSpread(_objectSpread({}, kindMemo), {}, (0, _defineProperty2.default)({}, entityConfig.name, entity(entityConfig)));
      }, {}));
...
function embedPreviews() {
  ...
  switch (action.type) {
    case 'RECEIVE_EMBED_PREVIEW':
      ...
      return _objectSpread(_objectSpread({}, state), {}, (0, _defineProperty2.default)({}, url, preview));
  }
...
function userPermissions() {
  ...
  switch (action.type) {
    case 'RECEIVE_USER_PERMISSION':
      return _objectSpread(_objectSpread({}, state), {}, (0, _defineProperty2.default)({}, action.key, action.isAllowed));
  }
...
function autosaves() {
  ...
  switch (action.type) {
    case 'RECEIVE_AUTOSAVES':
      ...
      return _objectSpread(_objectSpread({}, state), {}, (0, _defineProperty2.default)({}, postId, autosavesData));
  }
