...
var _marked = /*#__PURE__*/_regenerator.default.mark(deleteEntityRecord),
    _marked2 = /*#__PURE__*/_regenerator.default.mark(editEntityRecord),
    _marked3 = /*#__PURE__*/_regenerator.default.mark(undo),
    _marked4 = /*#__PURE__*/_regenerator.default.mark(redo),
    _marked5 = /*#__PURE__*/_regenerator.default.mark(saveEntityRecord),
    _marked6 = /*#__PURE__*/_regenerator.default.mark(saveEditedEntityRecord);
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 3;
          return (0, _dataControls.syncSelect)('core', 'getEntity', kind, name);
        ...
        case 6:
          ...
          _context2.next = 9;
          return (0, _dataControls.syncSelect)('core', 'getRawEntityRecord', kind, name, recordId);

        case 9:
          record = _context2.sent;
          _context2.next = 12;
          return (0, _dataControls.syncSelect)('core', 'getEditedEntityRecord', kind, name, recordId);
  ...
  return _regenerator.default.wrap(function undo$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return (0, _dataControls.syncSelect)('core', 'getUndoEdit');
  ...
  return _regenerator.default.wrap(function redo$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
          return (0, _dataControls.syncSelect)('core', 'getRedoEdit');
    ...
    while (1) {
      switch (_context5.prev = _context5.next) {
        ...
        case 30:
          ...
          _context5.next = 34;
          return (0, _dataControls.syncSelect)('core', 'getCurrentUser');

        case 34:
          currentUser = _context5.sent;
          currentUserId = currentUser ? currentUser.id : undefined;
          _context5.next = 38;
          return (0, _dataControls.syncSelect)('core', 'getAutosave', persistedRecord.type, persistedRecord.id, currentUserId);
        ...
        case 55:
          ...
          _context5.next = 59;
          return (0, _dataControls.syncSelect)('core', '__experimentalGetEntityRecordNoResolver', kind, name, recordId);

        case 59:
          persistedEntity = _context5.sent;
          _context5.next = 62;
          return (0, _dataControls.syncSelect)('core', 'getEntityRecordEdits', kind, name, recordId);
  ...
  return _regenerator.default.wrap(function saveEditedEntityRecord$(_context6) {
    while (1) {
      switch (_context6.prev = _context6.next) {
        case 0:
          _context6.next = 2;
          return (0, _dataControls.syncSelect)('core', 'hasEditsForEntityRecord', kind, name, recordId);
        ...
        case 4:
          _context6.next = 6;
          return (0, _dataControls.syncSelect)('core', 'getEntityRecordNonTransientEdits', kind, name, recordId);
