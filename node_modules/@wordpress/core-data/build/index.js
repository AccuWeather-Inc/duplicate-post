...
var entityActions = _entities.defaultEntities.reduce(function (result, entity) {
  ...
  result[(0, _entities.getMethodName)(kind, name, 'delete')] = function (key, query) {
    return actions.deleteEntityRecord(kind, name, key, query);
  };
...
(0, _data.registerStore)(_name.REDUCER_KEY, {
  ...
  actions: _objectSpread(_objectSpread({}, actions), entityActions),
  selectors: _objectSpread(_objectSpread({}, selectors), entitySelectors),
  resolvers: _objectSpread(_objectSpread({}, resolvers), entityResolvers)
});
