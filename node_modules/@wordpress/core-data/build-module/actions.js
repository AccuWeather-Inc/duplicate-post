    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 3;
          return syncSelect('core', 'getEntity', kind, name);
        ...
        case 6:
          ...
          _context2.next = 9;
          return syncSelect('core', 'getRawEntityRecord', kind, name, recordId);

        case 9:
          record = _context2.sent;
          _context2.next = 12;
          return syncSelect('core', 'getEditedEntityRecord', kind, name, recordId);
  ...
  return _regeneratorRuntime.wrap(function undo$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return syncSelect('core', 'getUndoEdit');
  ...
  return _regeneratorRuntime.wrap(function redo$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
          return syncSelect('core', 'getRedoEdit');
    ...
    while (1) {
      switch (_context5.prev = _context5.next) {
        ...
        case 30:
          ...
          _context5.next = 34;
          return syncSelect('core', 'getCurrentUser');

        case 34:
          currentUser = _context5.sent;
          currentUserId = currentUser ? currentUser.id : undefined;
          _context5.next = 38;
          return syncSelect('core', 'getAutosave', persistedRecord.type, persistedRecord.id, currentUserId);
        ...
        case 55:
          ...
          _context5.next = 59;
          return syncSelect('core', '__experimentalGetEntityRecordNoResolver', kind, name, recordId);

        case 59:
          persistedEntity = _context5.sent;
          _context5.next = 62;
          return syncSelect('core', 'getEntityRecordEdits', kind, name, recordId);
  ...
  return _regeneratorRuntime.wrap(function saveEditedEntityRecord$(_context6) {
    while (1) {
      switch (_context6.prev = _context6.next) {
        case 0:
          _context6.next = 2;
          return syncSelect('core', 'hasEditsForEntityRecord', kind, name, recordId);
        ...
        case 4:
          _context6.next = 6;
          return syncSelect('core', 'getEntityRecordNonTransientEdits', kind, name, recordId);
