        ...
        case 8:
          if (query !== undefined && query._fields) {
            ...
            query = _objectSpread(_objectSpread({}, query), {}, {
              _fields: uniq([].concat(_toConsumableArray(getNormalizedCommaSeparable(query._fields) || []), [entity.key || DEFAULT_ENTITY_KEY])).join()
            });
          ...
          path = addQueryArgs(entity.baseURL + '/' + key, _objectSpread(_objectSpread({}, query), {}, {
            context: 'edit'
          }));
          ...
          _context3.next = 14;
          return syncSelect('core', 'hasEntityRecords', kind, name, query);
    ...
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 7:
          ...
          path = addQueryArgs(entity.baseURL, _objectSpread(_objectSpread({}, query), {}, {
            context: 'edit'
          }));
          _context4.t0 = Object;
          _context4.next = 12;
  ...
  return _regeneratorRuntime.wrap(function getAutosave$(_context11) {
    while (1) {
      switch (_context11.prev = _context11.next) {
        case 0:
          _context11.next = 2;
          return select('core', 'getAutosaves', postType, postId);
