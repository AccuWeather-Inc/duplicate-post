...
var Editor = /*#__PURE__*/function (_Component) {
  ...
  (0, _createClass2.default)(Editor, [{
    ...
    value: function getEditorSettings(settings, hasFixedToolbar, focusMode, hiddenBlockTypes, blockTypes, colors, gradients) {
    ...
    value: function componentDidMount() {
      ...
      this.subscriptionParentSetFocusOnTitle = (0, _reactNativeBridge.subscribeSetFocusOnTitle)(function () {
    ...
    key: "editorMode",
    value: function editorMode(initialHtml, _editorMode) {
      if (_editorMode === 'preview') {
        return (0, _element.createElement)(_blockEditor.Preview, {
          blocks: (0, _blocks.rawHandler)({
            HTML: initialHtml
          })
        });
      }
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          gradients = _this$props.gradients,
          initialHtml = _this$props.initialHtml,
          editorMode = _this$props.editorMode,
          props = (0, _objectWithoutProperties2.default)(_this$props, ["settings", "hasFixedToolbar", "focusMode", "initialEdits", "hiddenBlockTypes", "blockTypes", "post", "postId", "postType", "colors", "gradients", "initialHtml", "editorMode"]);
      var editorSettings = this.getEditorSettings(settings, hasFixedToolbar, focusMode, hiddenBlockTypes, blockTypes, colors, gradients);
      ...
      }, props), this.editorMode(initialHtml, editorMode)));
    }
  }]);
  return Editor;
}(_element.Component);
