...
var _popoverWrapper = _interopRequireDefault(require("./popover-wrapper"));
...
function Layout() {
  ...
  return (0, _element.createElement)(_element.Fragment, null, (0, _element.createElement)(_interface.FullscreenMode, {
    ...
    leftSidebar: mode === 'visual' && isInserterOpened && (0, _element.createElement)(_popoverWrapper.default, {
    ...
    footer: !hasReducedUI && !isMobileViewport && isRichEditingEnabled && mode === 'visual' && (0, _element.createElement)("div", {
