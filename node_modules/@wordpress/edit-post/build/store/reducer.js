...
var preferences = (0, _lodash.flow)([_data.combineReducers, createWithInitialState(_defaults.PREFERENCES_DEFAULTS)])({
      ...
      case 'TOGGLE_PANEL_ENABLED':
        {
          ...
          return _objectSpread(_objectSpread({}, state), {}, (0, _defineProperty2.default)({}, panelName, _objectSpread(_objectSpread({}, state[panelName]), {}, {
      ...
      case 'TOGGLE_PANEL_OPENED':
        {
          ...
          return _objectSpread(_objectSpread({}, state), {}, (0, _defineProperty2.default)({}, _panelName, _objectSpread(_objectSpread({}, state[_panelName]), {}, {
            opened: !isOpen
          })));
        }
    }
  ...
  features: function features(state, action) {
    if (action.type === 'TOGGLE_FEATURE') {
      return _objectSpread(_objectSpread({}, state), {}, (0, _defineProperty2.default)({}, action.feature, !state[action.feature]));
    }
      ...
      case 'UPDATE_PREFERRED_STYLE_VARIATIONS':
        {
          ...
          return _objectSpread(_objectSpread({}, state), {}, (0, _defineProperty2.default)({}, action.blockName, action.blockStyle));
        }
    }
