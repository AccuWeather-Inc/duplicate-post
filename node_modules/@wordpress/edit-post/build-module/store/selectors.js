...
export var isEditorSidebarOpened = createRegistrySelector(function (select) {
  return function () {
...
export var isPluginSidebarOpened = createRegistrySelector(function (select) {
  return function () {
    var activeGeneralSidebar = select('core/interface').getActiveComplementaryArea('core/edit-post');
    return !!activeGeneralSidebar && !includes(['edit-post/document', 'edit-post/block'], activeGeneralSidebar);
  };
});
/**
...
export var getActiveGeneralSidebarName = createRegistrySelector(function (select) {
  return function () {
...
export var isPluginItemPinned = createRegistrySelector(function (select) {
