...
import { BaseControl, Button, FocalPointPicker, PanelBody, PanelRow, RangeControl, ResizableBox, Spinner, ToggleControl, withNotices, __experimentalBoxControl as BoxControl } from '@wordpress/components';
import { compose, withInstanceId, useInstanceId } from '@wordpress/compose';
import { BlockControls, BlockIcon, InspectorControls, MediaPlaceholder, MediaReplaceFlow, withColors, ColorPalette, useBlockProps, __experimentalUseInnerBlocksProps as useInnerBlocksProps, __experimentalUseGradient, __experimentalPanelColorGradientSettings as PanelColorGradientSettings, __experimentalUnitControl as UnitControl, __experimentalBlockAlignmentMatrixToolbar as BlockAlignmentMatrixToolbar } from '@wordpress/block-editor';
...
function CoverEdit(_ref3) {
  ...
  }, canDim && createElement(RangeControl, {
    label: __('Opacity'),
    value: dimRatio,
  ...
  }), isBlogUrl && createElement(Spinner, null), createElement("div", innerBlocksProps)));
}
