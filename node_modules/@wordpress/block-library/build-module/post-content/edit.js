...
export default function PostContentEdit(_ref) {
  ...
  var blockProps = useBlockProps(); // Only render InnerBlocks if the context is different from the active post
  ...
  if (contextPostId && contextPostType && contextPostId !== currentPostId && contextPostType !== currentPostType) {
    return createElement("div", blockProps, createElement(PostContentInnerBlocks, {
