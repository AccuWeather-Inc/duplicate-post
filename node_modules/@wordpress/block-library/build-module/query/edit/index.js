...
export default function QueryEdit(_ref) {
  ...
  useEffect(function () {
    ...
    if (postId && !((_query$exclude = query.exclude) === null || _query$exclude === void 0 ? void 0 : _query$exclude.length)) {
  ...
  }, [query.perPage, query.exclude, postId]); // We need this for multi-query block pagination.
  ...
  return createElement(Fragment, null, createElement(QueryInspectorControls, {
    ...
    query: query,
    setQuery: updateQuery
  })), createElement("div", blockProps, createElement(QueryProvider, null, createElement(InnerBlocks, {
    template: TEMPLATE,
