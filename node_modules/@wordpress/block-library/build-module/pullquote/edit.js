...
import { RichText, ContrastChecker, InspectorControls, withColors, PanelColorSettings, useBlockProps } from '@wordpress/block-editor';
...
function PullQuoteEdit(_ref) {
  ...
  var wasTextColorAutomaticallyComputed = useRef(false);
  ...
  return createElement(Fragment, null, createElement(Figure, newBlockProps, createElement(BlockQuote, {
    style: {
      color: textColor.color
    },
    className: textColor.color && classnames('has-text-color', _defineProperty({}, textColor.class, textColor.class))
