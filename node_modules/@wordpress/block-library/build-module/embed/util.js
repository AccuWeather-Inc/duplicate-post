...
export var getEmbedInfoByProvider = function getEmbedInfoByProvider(provider) {
  var _getBlockVariations;

  return (_getBlockVariations = getBlockVariations(DEFAULT_EMBED_BLOCK)) === null || _getBlockVariations === void 0 ? void 0 : _getBlockVariations.find(function (_ref) {
    var name = _ref.name;
...
export var findMoreSuitableBlock = function findMoreSuitableBlock(url) {
  var _getBlockVariations2;

  return (_getBlockVariations2 = getBlockVariations(DEFAULT_EMBED_BLOCK)) === null || _getBlockVariations2 === void 0 ? void 0 : _getBlockVariations2.find(function (_ref2) {
...
export var createUpgradedEmbedBlock = function createUpgradedEmbedBlock(props) {
  ...
  if (shouldCreateNewBlock) {
    return createBlock(DEFAULT_EMBED_BLOCK, _objectSpread({
      url: url
    }, matchedBlock.attributes));
  }

  var wpVariation = (_getBlockVariations3 = getBlockVariations(DEFAULT_EMBED_BLOCK)) === null || _getBlockVariations3 === void 0 ? void 0 : _getBlockVariations3.find(function (_ref3) {
    var name = _ref3.name;
  ...
  return createBlock(DEFAULT_EMBED_BLOCK, _objectSpread(_objectSpread({
    url: url
...
export var removeAspectRatioClasses = function removeAspectRatioClasses(existingClassNames) {
...
export var getAttributesFromPreview = memoize(function (preview, title, currentClassNames, isResponsive) {
  ...
  var providerNameSlug = kebabCase((providerName || title).toLowerCase());
