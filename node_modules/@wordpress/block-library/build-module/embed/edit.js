...
var EmbedEdit = function EmbedEdit(props) {
  ...
  if (fetching) {
    return createElement("div", blockProps, createElement(EmbedLoading, null));
  ...
  if (showEmbedPlaceholder) {
    return createElement("div", blockProps, createElement(EmbedPlaceholder, {
      icon: icon,
      label: label,
  ...
  }), createElement("div", blockProps, createElement(EmbedPreview, {
    preview: preview,
