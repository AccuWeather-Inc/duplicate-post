...
import { registerBlockType, setDefaultBlockName, setFreeformContentHandlerName, setUnregisteredTypeHandlerName, setGroupingBlockName, unstable__bootstrapServerSideBlockDefinitions // eslint-disable-line camelcase
...
import * as socialLink from './social-link'; // Full Site Editing Blocks
...
var registerBlock = function registerBlock(block) {
  ...
  if (metadata) {
    unstable__bootstrapServerSideBlockDefinitions(_defineProperty({}, name, metadata));
  }
...
export var __experimentalGetCoreBlocks = function __experimentalGetCoreBlocks() {
