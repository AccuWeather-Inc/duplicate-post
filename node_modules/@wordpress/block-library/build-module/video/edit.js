...
import { BlockControls, BlockIcon, InspectorControls, MediaPlaceholder, MediaUpload, MediaUploadCheck, MediaReplaceFlow, RichText, useBlockProps } from '@wordpress/block-editor';
...
function VideoEdit(_ref) {
  ...
  return createElement(Fragment, null, createElement(BlockControls, null, createElement(TracksEditor, {
    tracks: tracks,
  ...
  __('The current poster image url is %s'), poster) : __('There is no poster image currently selected')), !!poster && createElement(Button, {
    ...
    isTertiary: true
  }, __('Remove')))))), createElement("figure", blockProps, createElement(Disabled, null, createElement("video", {
    controls: controls,
    poster: poster,
    src: src,
    ref: videoPlayer
