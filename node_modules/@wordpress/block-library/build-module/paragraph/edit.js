...
import { AlignmentToolbar, BlockControls, InspectorControls, RichText, useBlockProps, getFontSize, __experimentalUseEditorFeature as useEditorFeature } from '@wordpress/block-editor';
...
function useDropCapMinHeight(ref, isDisabled, dependencies) {
  ...
  }, [isDisabled].concat(_toConsumableArray(dependencies)));
  return minHeight;
}
...
function ParagraphBlock(_ref2) {
  ...
  var size = useSelect(function (select) {
