...
import { BlockContextProvider, InnerBlocks, BlockPreview, useBlockProps } from '@wordpress/block-editor';
/**
...
export default function QueryLoopEdit(_ref) {
  ...
  }, [perPage, page, offset, categoryIds, tagIds, order, orderBy, clientId, author, search, postType, exclude]),
  ...
  if (!posts) {
    return createElement("p", blockProps, __('Loading…'));
  }
  ...
  return createElement("div", blockProps, blockContexts && blockContexts.map(function (blockContext) {
