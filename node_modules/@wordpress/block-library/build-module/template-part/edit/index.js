...
export default function TemplatePartEdit(_ref) {
  ...
  var blockProps = useBlockProps(); // Part of a template file, post ID already resolved.
  ...
  return createElement(TagName, blockProps, isPlaceholder && createElement(TemplatePartPlaceholder, {
