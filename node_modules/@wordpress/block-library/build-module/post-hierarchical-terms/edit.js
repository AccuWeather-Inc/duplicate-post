...
import { AlignmentToolbar, BlockControls, Warning, useBlockProps, __experimentalBlockVariationPicker as BlockVariationPicker } from '@wordpress/block-editor';
...
export default function PostHierarchicalTermsEdit(_ref) {
  ...
  if (!hasPost) {
    return createElement("div", blockProps, createElement(Warning, null, __('Post Hierarchical Terms block: post not found.')));
  }

  if (!term) {
    var _blockType$icon;

    return createElement("div", blockProps, createElement(BlockVariationPicker, {
  ...
  })), createElement("div", blockProps, isLoadingHierarchicalTermLinks && createElement(Spinner, null), hasHierarchicalTermLinks && !isLoadingHierarchicalTermLinks && hierarchicalTermLinks.reduce(function (prev, curr) {
    return [prev, ' | ', curr];
