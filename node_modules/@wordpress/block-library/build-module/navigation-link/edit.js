...
import { BlockControls, InnerBlocks, __experimentalUseInnerBlocksProps as useInnerBlocksProps, InspectorControls, RichText, __experimentalLinkControl as LinkControl, useBlockProps } from '@wordpress/block-editor';
...
function NavigationLinkEdit(_ref) {
  ...
  return createElement(Fragment, null, createElement(BlockControls, null, createElement(ToolbarGroup, null, createElement(KeyboardShortcuts, {
    ...
    label: __('Link rel'),
    autoComplete: "off"
  }))), createElement("li", blockProps, createElement("div", {
