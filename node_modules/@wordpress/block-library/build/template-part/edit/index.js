...
function TemplatePartEdit(_ref) {
  ...
  var blockProps = (0, _blockEditor.useBlockProps)(); // Part of a template file, post ID already resolved.
  ...
  return (0, _element.createElement)(TagName, blockProps, isPlaceholder && (0, _element.createElement)(_placeholder.default, {
