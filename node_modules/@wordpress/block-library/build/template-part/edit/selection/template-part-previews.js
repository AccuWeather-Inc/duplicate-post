...
function TemplatePartItem(_ref) {
  ...
  return (0, _element.createElement)(_reakit.CompositeItem, (0, _extends2.default)({
...
function TemplateParts(_ref6) {
  ...
  var templateParts = (0, _data.useSelect)(function (select) {
    ...
    var currentTheme = (_select$getCurrentThe = select('core').getCurrentTheme()) === null || _select$getCurrentThe === void 0 ? void 0 : _select$getCurrentThe.stylesheet;
  ...
  if (filterValue) {
    return (0, _element.createElement)(_reakit.Composite, (0, _extends2.default)({}, composite, {
      role: "list",
  ...
  return (0, _element.createElement)(_reakit.Composite, (0, _extends2.default)({}, composite, {
    role: "list",
    "aria-label": (0, _i18n.__)('List of template parts')
  }), (0, _element.createElement)(TemplatePartsByTheme, {
    templateParts: templateParts,
    setAttributes: setAttributes,
    onClose: onClose,
    composite: composite
