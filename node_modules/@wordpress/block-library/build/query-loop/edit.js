...
function QueryLoopEdit(_ref) {
  ...
  if (!posts) {
    return (0, _element.createElement)("p", blockProps, (0, _i18n.__)('Loading…'));
  }
  ...
  return (0, _element.createElement)("div", blockProps, blockContexts && blockContexts.map(function (blockContext) {
