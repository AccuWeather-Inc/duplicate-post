...
function PostHierarchicalTermsEdit(_ref) {
  ...
  if (!hasPost) {
    return (0, _element.createElement)("div", blockProps, (0, _element.createElement)(_blockEditor.Warning, null, (0, _i18n.__)('Post Hierarchical Terms block: post not found.')));
  }
  ...
  })), (0, _element.createElement)("div", blockProps, isLoadingHierarchicalTermLinks && (0, _element.createElement)(_components.Spinner, null), hasHierarchicalTermLinks && !isLoadingHierarchicalTermLinks && hierarchicalTermLinks.reduce(function (prev, curr) {
    return [prev, ' | ', curr];
