...
function useDropCapMinHeight(ref, isDisabled, dependencies) {
  ...
  }, [isDisabled].concat((0, _toConsumableArray2.default)(dependencies)));
  return minHeight;
}
...
function ParagraphBlock(_ref2) {
  ...
  var isDropCapFeatureEnabled = (0, _blockEditor.__experimentalUseEditorFeature)('typography.dropCap');
  var ref = (0, _element.useRef)();
  var inlineFontSize = style === null || style === void 0 ? void 0 : style.fontSize;
  var size = (0, _data.useSelect)(function (select) {
    var _select$getSettings = select('core/block-editor').getSettings(),
        fontSizes = _select$getSettings.fontSizes;

    return (0, _blockEditor.getFontSize)(fontSizes, fontSize, inlineFontSize).size;
