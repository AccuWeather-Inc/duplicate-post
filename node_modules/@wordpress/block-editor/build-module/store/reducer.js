      ...
      case 'UPDATE_BLOCK_ATTRIBUTES':
        {
          ...
          var next = action.clientIds.reduce(function (accumulator, id) {
            return _objectSpread(_objectSpread({}, accumulator), {}, _defineProperty({}, id, reduce(action.attributes, function (result, value, key) {
  ...
  switch (action.type) {
    ...
    case 'UPDATE_BLOCK_ATTRIBUTES':
      return action.clientIds.reduce(function (accumulator, id) {
        return _objectSpread(_objectSpread({}, accumulator), {}, _defineProperty({}, id, action.attributes));
      }, {});
  }
