 ...
 */
import { castArray, flatMap, first, isArray, isBoolean, last, map, reduce, some, find, filter } from 'lodash';
import createSelector from 'rememo';
/**
 * WordPress dependencies
 */

import { getBlockType, getBlockTypes, hasBlockSupport, parse } from '@wordpress/blocks';
...
export var getInserterItems = createSelector(function (state) {
  ...
  var buildBlockTypeInserterItem = function buildBlockTypeInserterItem(blockType) {
    ...
    var _ref3 = getInsertUsage(state, id) || {},
        time = _ref3.time,
        _ref3$count = _ref3.count,
        count = _ref3$count === void 0 ? 0 : _ref3$count;

    var inserterVariations = blockType.variations.filter(function (_ref4) {
  ...
  var visibleBlockTypeInserterItems = blockTypeInserterItems.filter(function (_ref6) {
    var _ref6$variations = _ref6.variations,
        variations = _ref6$variations === void 0 ? [] : _ref6$variations;
    return !variations.some(function (_ref7) {
      var isDefault = _ref7.isDefault;
      return isDefault;
    });
  });
  ...
  return [].concat(_toConsumableArray(visibleBlockTypeInserterItems), blockVariations, _toConsumableArray(reusableBlockInserterItems));
}, function (state, rootClientId) {
...
export var __experimentalGetBlockListSettingsForBlocks = createSelector(function (state, clientIds) {
  return filter(state.blockListSettings, function (value, key) {
...
export var __experimentalGetActiveBlockIdByBlockNames = createSelector(function (state, validBlockNames) {
  ...
  return [state.selectionStart.clientId, state.selectionEnd.clientId, validBlockNames];
});
