...
var _marked = /*#__PURE__*/_regeneratorRuntime.mark(ensureDefaultBlock),
    ...
    _marked5 = /*#__PURE__*/_regeneratorRuntime.mark(moveBlocksToPosition),
    _marked6 = /*#__PURE__*/_regeneratorRuntime.mark(moveBlockToPosition),
    _marked7 = /*#__PURE__*/_regeneratorRuntime.mark(insertBlocks),
    _marked8 = /*#__PURE__*/_regeneratorRuntime.mark(removeBlocks),
    _marked9 = /*#__PURE__*/_regeneratorRuntime.mark(setNavigationMode),
    _marked10 = /*#__PURE__*/_regeneratorRuntime.mark(setBlockMovingClientId),
    _marked11 = /*#__PURE__*/_regeneratorRuntime.mark(duplicateBlocks),
    _marked12 = /*#__PURE__*/_regeneratorRuntime.mark(insertBeforeBlock),
    _marked13 = /*#__PURE__*/_regeneratorRuntime.mark(insertAfterBlock),
    _marked14 = /*#__PURE__*/_regeneratorRuntime.mark(flashBlock);
...
import { cloneBlock, createBlock, getDefaultBlockName, hasBlockSupport } from '@wordpress/blocks';
  ...
  return _regeneratorRuntime.wrap(function ensureDefaultBlock$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return controls.select('core/block-editor', 'getBlockCount');
  ...
  return _regeneratorRuntime.wrap(function selectPreviousBlock$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return controls.select('core/block-editor', 'getPreviousBlockClientId', clientId);
  ...
  return _regeneratorRuntime.wrap(function selectNextBlock$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return controls.select('core/block-editor', 'getNextBlockClientId', clientId);
...
export function replaceBlocks(clientIds, blocks, indexToSelect, initialPosition, meta) {
    ...
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _context4.next = 5;
          return controls.select('core/block-editor', 'getSettings');

        case 5:
          _context4.t2 = _context4.sent;
          blocks = (0, _context4.t0)(_context4.t1, _context4.t2);
          _context4.next = 9;
          return controls.select('core/block-editor', 'getBlockRootClientId', first(clientIds));
        ...
        case 11:
          ...
          block = blocks[index];
          _context4.next = 15;
          return controls.select('core/block-editor', 'canInsertBlockType', block.name, rootClientId);
...
export function moveBlocksToPosition(clientIds) {
  var fromRootClientId,
      ...
      canInsertBlocks,
      _args5 = arguments;
  return _regeneratorRuntime.wrap(function moveBlocksToPosition$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.next = 5;
          return controls.select('core/block-editor', 'getTemplateLock', fromRootClientId);
        ...
        case 15:
          _context5.next = 17;
          return controls.select('core/block-editor', 'canInsertBlocks', clientIds, toRootClientId);
...
export function moveBlockToPosition(clientId) {
  var fromRootClientId,
      ...
      index,
      _args6 = arguments;
  return _regeneratorRuntime.wrap(function moveBlockToPosition$(_context6) {
    while (1) {
...
export function insertBlocks(blocks, index, rootClientId) {
  ...
  return _regeneratorRuntime.wrap(function insertBlocks$(_context7) {
    while (1) {
...
export function removeBlocks(clientIds) {
  var selectPrevious,
      ...
      defaultBlockId,
      _args8 = arguments;
  return _regeneratorRuntime.wrap(function removeBlocks$(_context8) {
    while (1) {
      switch (_context8.prev = _context8.next) {
        ...
        case 3:
          clientIds = castArray(clientIds);
          _context8.next = 6;
          return controls.select('core/block-editor', 'getBlockRootClientId', clientIds[0]);

        case 6:
          rootClientId = _context8.sent;
          _context8.next = 9;
          return controls.select('core/block-editor', 'getTemplateLock', rootClientId);
        ...
        case 18:
          _context8.next = 20;
          return controls.select('core/block-editor', 'getPreviousBlockClientId', clientIds[0]);
...
export function setNavigationMode() {
  var isNavigationMode,
      _args9 = arguments;
  return _regeneratorRuntime.wrap(function setNavigationMode$(_context9) {
    while (1) {
...
export function setBlockMovingClientId() {
  var hasBlockMovingClientId,
      _args10 = arguments;
  return _regeneratorRuntime.wrap(function setBlockMovingClientId$(_context10) {
    while (1) {
...
export function duplicateBlocks(clientIds) {
  var updateSelection,
      ...
      clonedBlocks,
      _args11 = arguments;
  return _regeneratorRuntime.wrap(function duplicateBlocks$(_context11) {
    while (1) {
      switch (_context11.prev = _context11.next) {
        ...
        case 3:
          _context11.next = 5;
          return controls.select('core/block-editor', 'getBlocksByClientId', clientIds);
        ...
        case 14:
          _context11.next = 16;
          return controls.select('core/block-editor', 'getBlockIndex', last(castArray(clientIds)), rootClientId);
...
export function insertBeforeBlock(clientId) {
  ...
  return _regeneratorRuntime.wrap(function insertBeforeBlock$(_context12) {
    while (1) {
      switch (_context12.prev = _context12.next) {
        ...
        case 2:
          _context12.next = 4;
          return controls.select('core/block-editor', 'getBlockRootClientId', clientId);
        ...
        case 10:
          _context12.next = 12;
          return controls.select('core/block-editor', 'getBlockIndex', clientId, rootClientId);
...
export function insertAfterBlock(clientId) {
  var rootClientId, isLocked, firstSelectedIndex;
  return _regeneratorRuntime.wrap(function insertAfterBlock$(_context13) {
    while (1) {
...
export function flashBlock(clientId) {
  return _regeneratorRuntime.wrap(function flashBlock$(_context14) {
    while (1) {
