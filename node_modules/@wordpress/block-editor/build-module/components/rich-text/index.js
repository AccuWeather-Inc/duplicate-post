  ...
  var content = createElement(RichText, {
    ...
    return createElement(Fragment, null, children && children({
      ...
      return createElement(TagName, _extends({}, editableProps, props, {
        style: props.style ? _objectSpread(_objectSpread({}, props.style), editableProps.style) : editableProps.style,
        className: classnames(classes, props.className, editableProps.className, {
