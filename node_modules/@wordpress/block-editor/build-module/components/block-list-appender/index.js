...
import ButtonBlockAppender from '../button-block-appender'; // A Context to store the map of the appender map.

export var AppenderNodesContext = createContext();
...
function BlockListAppender(_ref) {
  ...
  var appenderNodesMap = useContext(AppenderNodesContext);
  ...
  , {
    ...
    ref: function ref(_ref2) {
      if (_ref2) {
        ...
        appenderNodesMap.set(rootClientId || '', _ref2);
      } else {
