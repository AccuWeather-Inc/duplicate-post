...
function BlockListBlock(_ref2) {
  ...
  var isLargeViewport = useViewportMatch('medium'); // In addition to withSelect, we should favor using useSelect in this
  ...
  var lightBlockWrapper = blockType.apiVersion > 1 || hasBlockSupport(blockType, 'lightBlockWrapper', false);
