...
import BlockListAppender, { AppenderNodesContext } from '../block-list-appender';
...
function BlockList(_ref, ref) {
  ...
  var wrapperRef = ref || fallbackRef;
  return createElement(AppenderNodesContext.Provider, {
    value: appenderNodesMap
