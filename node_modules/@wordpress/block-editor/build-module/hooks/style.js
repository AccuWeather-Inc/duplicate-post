...
var styleSupportKeys = [].concat(_toConsumableArray(TYPOGRAPHY_SUPPORT_KEYS), [COLOR_SUPPORT_KEY, SPACING_SUPPORT_KEY]);
...
export var withBlockControls = createHigherOrderComponent(function (BlockEdit) {
  return function (props) {
    ...
    var hasSpacingSupport = hasBlockSupport(blockName, SPACING_SUPPORT_KEY);
    return [createElement(TypographyPanel, _extends({
      ...
      key: "edit"
    }, props)), hasSpacingSupport && createElement(SpacingPanelControl, {
      key: "spacing"
