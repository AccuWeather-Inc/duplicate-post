...
var styleSupportKeys = [].concat((0, _toConsumableArray2.default)(_typography.TYPOGRAPHY_SUPPORT_KEYS), [_color.COLOR_SUPPORT_KEY, _padding.SPACING_SUPPORT_KEY]);
...
var withBlockControls = (0, _compose.createHigherOrderComponent)(function (BlockEdit) {
  return function (props) {
    ...
    var hasSpacingSupport = (0, _blocks.hasBlockSupport)(blockName, _padding.SPACING_SUPPORT_KEY);
    return [(0, _element.createElement)(_typography.TypographyPanel, (0, _extends2.default)({
      ...
      key: "edit"
    }, props)), hasSpacingSupport && (0, _element.createElement)(_spacingPanelControl.default, {
      key: "spacing"
