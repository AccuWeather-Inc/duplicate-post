...
function Block(_ref) {
  ...
  return (0, _element.createElement)("div", (0, _blockWrapper.useBlockProps)(props, {
...
function BlockListBlock(_ref2) {
  ...
  var isLargeViewport = (0, _compose.useViewportMatch)('medium'); // In addition to withSelect, we should favor using useSelect in this
  ...
  var lightBlockWrapper = blockType.apiVersion > 1 || (0, _blocks.hasBlockSupport)(blockType, 'lightBlockWrapper', false);
