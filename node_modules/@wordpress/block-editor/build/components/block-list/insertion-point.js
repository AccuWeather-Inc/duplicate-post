...
var _blockListAppender = require("../block-list-appender");
...
function InsertionPointPopover(_ref2) {
  ...
  var appenderNodesMap = (0, _element.useContext)(_blockListAppender.AppenderNodesContext);
  var element = (0, _element.useMemo)(function () {
    if (clientId) {
      return (0, _dom2.getBlockDOMNode)(clientId);
