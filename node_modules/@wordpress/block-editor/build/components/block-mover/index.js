...
function BlockMover(_ref) {
  ...
  var dragHandleLabel = clientIds.length === 1 ? (0, _i18n.__)('Drag block') : (0, _i18n.__)('Drag blocks'); // We emulate a disabled state because forcefully applying the `disabled`
