  ...
  return _regenerator.default.wrap(function ensureDefaultBlock$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return _data.controls.select('core/block-editor', 'getBlockCount');
  ...
  return _regenerator.default.wrap(function selectPreviousBlock$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return _data.controls.select('core/block-editor', 'getPreviousBlockClientId', clientId);
  ...
  return _regenerator.default.wrap(function selectNextBlock$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return _data.controls.select('core/block-editor', 'getNextBlockClientId', clientId);
    ...
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _context4.next = 5;
          return _data.controls.select('core/block-editor', 'getSettings');

        case 5:
          _context4.t2 = _context4.sent;
          blocks = (0, _context4.t0)(_context4.t1, _context4.t2);
          _context4.next = 9;
          return _data.controls.select('core/block-editor', 'getBlockRootClientId', (0, _lodash.first)(clientIds));
        ...
        case 11:
          ...
          block = blocks[index];
          _context4.next = 15;
          return _data.controls.select('core/block-editor', 'canInsertBlockType', block.name, rootClientId);
    ...
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.next = 5;
          return _data.controls.select('core/block-editor', 'getTemplateLock', fromRootClientId);
        ...
        case 15:
          _context5.next = 17;
          return _data.controls.select('core/block-editor', 'canInsertBlocks', clientIds, toRootClientId);
    ...
    while (1) {
      switch (_context8.prev = _context8.next) {
        ...
        case 3:
          clientIds = (0, _lodash.castArray)(clientIds);
          _context8.next = 6;
          return _data.controls.select('core/block-editor', 'getBlockRootClientId', clientIds[0]);

        case 6:
          rootClientId = _context8.sent;
          _context8.next = 9;
          return _data.controls.select('core/block-editor', 'getTemplateLock', rootClientId);
        ...
        case 18:
          _context8.next = 20;
          return _data.controls.select('core/block-editor', 'getPreviousBlockClientId', clientIds[0]);
  ...
  return _regenerator.default.wrap(function duplicateBlocks$(_context11) {
    while (1) {
      switch (_context11.prev = _context11.next) {
        ...
        case 3:
          _context11.next = 5;
          return _data.controls.select('core/block-editor', 'getBlocksByClientId', clientIds);
        ...
        case 14:
          _context11.next = 16;
          return _data.controls.select('core/block-editor', 'getBlockIndex', (0, _lodash.last)((0, _lodash.castArray)(clientIds)), rootClientId);
  ...
  return _regenerator.default.wrap(function insertBeforeBlock$(_context12) {
    while (1) {
      switch (_context12.prev = _context12.next) {
        ...
        case 2:
          _context12.next = 4;
          return _data.controls.select('core/block-editor', 'getBlockRootClientId', clientId);
        ...
        case 10:
          _context12.next = 12;
          return _data.controls.select('core/block-editor', 'getBlockIndex', clientId, rootClientId);
